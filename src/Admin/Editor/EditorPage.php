...
class EditorPage
{
    ...
    private function get_editor_styles()
    {
        return [
            ...
            ['href' => CLIENT_BLOCKS_URL . 'assets/css/components/file-selector.css', 'version' => filemtime(CLIENT_BLOCKS_PATH . 'assets/css/components/file-selector.css')],
            ['href' => CLIENT_BLOCKS_URL . 'assets/css/components/global-files.css', 'version' => filemtime(CLIENT_BLOCKS_PATH . 'assets/css/components/global-files.css')],
    ...
    private function get_editor_scripts()
    {
        return [
            ...
            ['src' => 'https://unpkg.com/prettier@2.8.8/standalone.js', 'version' => '2.8.8'],
            ['src' => 'https://unpkg.com/prettier@2.8.8/parser-babel.js', 'version' => '2.8.8'],
            ['src' => 'https://unpkg.com/prettier@2.8.8/parser-postcss.js', 'version' => '2.8.8'],
            ['src' => 'https://unpkg.com/prettier@2.8.8/parser-html.js', 'version' => '2.8.8'],
            ['src' => 'https://unpkg.com/@shopify/prettier-plugin-liquid@1.1.0/standalone.js', 'version' => '1.1.0'],
            ['src' => 'https://unpkg.com/@prettier/plugin-php@0.19.6/standalone.js', 'version' => '0.19.6'],
            ['src' => 'https://cdnjs.cloudflare.com/ajax/libs/monaco-editor/0.44.0/min/vs/loader.min.js', 'version' => '0.44.0'],
            ['src' => CLIENT_BLOCKS_URL . 'assets/js/editor/formatters.js', 'version' => filemtime(CLIENT_BLOCKS_PATH . 'assets/js/editor/config.js')],
            ...
            ['src' => CLIENT_BLOCKS_URL . 'assets/js/editor/store.js', 'version' => filemtime(CLIENT_BLOCKS_PATH . 'assets/js/editor/store.js')],
            ['src' => CLIENT_BLOCKS_URL . 'assets/js/editor/monaco.js', 'version' => filemtime(CLIENT_BLOCKS_PATH . 'assets/js/editor/monaco.js')],
            ['src' => CLIENT_BLOCKS_URL . 'assets/js/editor/loader.js', 'version' => filemtime(CLIENT_BLOCKS_PATH . 'assets/js/editor/loader.js')],
            ['src' => CLIENT_BLOCKS_URL . 'assets/js/editor/save.js', 'version' => filemtime(CLIENT_BLOCKS_PATH . 'assets/js/editor/save.js')],
            ['src' => CLIENT_BLOCKS_URL . 'assets/js/editor/preview.js', 'version' => filemtime(CLIENT_BLOCKS_PATH . 'assets/js/editor/preview.js')],
            ['src' => CLIENT_BLOCKS_URL . 'assets/js/editor/global-files.js', 'version' => filemtime(CLIENT_BLOCKS_PATH . 'assets/js/editor/global-files.js')],
